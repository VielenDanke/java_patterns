...
public class ExpressionBuilder {
	...
	private void parse(PermissionEnum permission) {
		StringTokenizer tokenizer = new StringTokenizer(permission.name().toLowerCase());
		while (tokenizer.hasMoreTokens()) {
			...
			case "or":
				...
				break;
			default:
				permissions.push(new Permission(PermissionEnum.valueOf(token.toUpperCase())));
				break;
			}
		}
	}
